class TitleSet {
  /// Returns a new [TitleSet] instance
  TitleSet({
  ...
  /// Returns a new [TitleSet] instance and imports its values from a JSON map
  static TitleSet fromJson(Map<String, Object?> json) {
    ...
    throw FormatException('Could not deseria;ize TitleSet, json=$json');
  }
